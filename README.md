...
The application runs at http://localhost:2368 by default.

## Usage
The application is currently up to date with Angular 2 RC5.

The appication has used ng2-webpack generator from Yeoman.

If you want to use the following sub generators from yeoman:

npm install -g yo

npm install -g generator-ng2-webpack

Then you will have access to the following sub generators:
